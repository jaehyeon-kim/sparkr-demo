...
# Basic data manipulation (continued)
...
- expressions are interchangeable but not always
    + see UDFs below
...
- window functions introduced Spark 2 - [link](https://databricks.com/blog/2015/07/15/introducing-window-functions-in-spark-sql.html)
