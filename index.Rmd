...
- Note
    ...
    + Spark [log level](https://github.com/jaehyeon-kim/rocker-extra/blob/3.4.3/spark/spark-conf/log4j.properties#L19) to _WARN_ - too many info message can cause RStudio unresponsive
